...
public class MenuPPal extends javax.swing.JFrame {
    ...
    public void cargarPagina() throws SQLException, NoSuchAlgorithmException{ 
        this.btnAdministrador.setVisible(MiCriptografia.esAdministrador(cedula));
    }
    ...
    private void initComponents() {
        ...
        btnCifrarArchivo.setText("Cifrar Archivo");
        getContentPane().add(btnCifrarArchivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 180, -1, -1));

        jButton1.setText("Descifrar Archivo");
        ...
        jButton2.setText("Firmar Archivo");
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 280, -1, -1));

        jButton3.setText("Verificar Archivo");
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 180, 160, -1));

        jLabel3.setForeground(new java.awt.Color(255, 51, 51));
        jLabel3.setText("Clave de Cifrado/Descifrado obligatoria");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 220, -1, -1));

        btnAdministrador.setText("Menu Administrador");
        btnAdministrador.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAdministradorActionPerformed(evt);
            }
        });
        getContentPane().add(btnAdministrador, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 10, -1, -1));
    ...
    private void btnAdministradorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdministradorActionPerformed
        AdministracionMenu m = new AdministracionMenu();
        m.setVisible(true);
